...
**Attention:** I try to keep as close to possible with seafadm to the official Seafile releases. There are minor differences between releases which make small corrections necessary. Especially if you use an older version of Seafile you will need to use an older one seafadm too. See the tags to find a matching version.
